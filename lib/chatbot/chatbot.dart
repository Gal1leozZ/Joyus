...
class Chatbot_Screen extends StatefulWidget {
  Chatbot_Screen({Key key, this.title}) : super(key: key);
...
class _Chatbot_ScreenState extends State<Chatbot_Screen> {
    ...
    AuthGoogle authGoogle = await AuthGoogle(
        fileJson: "assets/chatbot/service.json")
        .build();
        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              child: Text("วันนี้, ${DateFormat("Hm").format(DateTime.now())}", style: TextStyle(
                fontSize: 20
              ),),
            ),
            Flexible(
