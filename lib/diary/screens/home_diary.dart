...
import 'package:joyus_app/diary/components/faderoute.dart';
import 'package:joyus_app/diary/data/models.dart';
import 'package:joyus_app/diary/screens/edit.dart';
import 'package:joyus_app/diary/screens/view.dart';
import 'package:joyus_app/diary/services/database.dart';
...
class MyHomePage_Diary extends StatefulWidget {
  ...
  MyHomePage_Diary({Key key, this.title, Function(Brightness brightness) changeTheme})
      : super(key: key) {
